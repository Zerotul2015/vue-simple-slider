<template>
  <div class="vue-simple-slider vhl-btn-right--list" ref="container">
...
export default {
  ...
  computed: {
    ...
    _options() {
      ...
      let responsive3 = {start: 768, end: 992, size: 3};
      let responsive4 = {start: 992, end: 1200, size: 4};
      let responsive5 = {start: 1200, size: 5};
