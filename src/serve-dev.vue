<template>
  <div id="app">
    ...
    <section>
      <vue-simple-slider :items="items" :options="{responsive: [{size: 1}]}">
    ...
    <section>
      <vue-simple-slider :items="items" :options="{responsive: [{end: 576, size: 1}, {size: 2}]}">
        <template v-slot:default="{item}">
          <div class="item">
            <h5>{{item.title}}</h5>
            <p>{{item.content}}</p>
...
<script>
  import Vue from 'vue';
  import VueHorizontalListAuto from '@/vue-simple-slider.vue';
